...
<head>
    ...
    <title>Transfer</title>
     <script>
        ...
        function validate(){
            var get = document.myform.recaccno.value;
            if(get===""){
                alert("Please enter receiver's account number");
                document.myform.recaccno.focus;
                return false;
            }
            
            var get = document.myform.transamount.value;
            if(get===""){
                alert("Please enter amount");
                document.myform.transamount.focus;
                return false;
            }
            ...
            <div class="header">
                ...
                <div class="sim">
                    <div class="user-sim">
                        ...
                        <center>
                            <form name="myform" action="transfersuccess.jsp">
                            <input type="number" name="recaccno" placeholder="Receiver's Account no">
                            <br>
                            <br>
                            <input type="number" name="transamount" placeholder="Amount">
                            <br>
                            <br>
                            <input type="submit" class="btn" name="dipth" value="Transfer" onclick="return validate()">
                        </form>
                    </center>
                </div>
