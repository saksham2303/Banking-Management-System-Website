...
<head>
    ...
    <script>
        ...
        function validate(){
            var get = document.myform.dipamount.value;
            if(get===""){
                alert("Please enter amount");
                document.myform.dipamount.focus;
                return false;
            }
        ...
        <div class="side">
            ...
            <div class="py pi">
               ...
               <a href="deposit.jsp">Deposit</a>
                ...
                <br>
               <br>
               <a href="withdraw.jsp">Withdraw History</a>
                <br>
                <br>
                <br>
               <br>
            ...
            <div class="header">
                ...
                <div class="sim">
                    <div class="user-sim">
                        ...
                        <br>
                        <center>
                            <form name="myform" action="dipsuccess.jsp">
                            <input type="number" name="dipamount" placeholder="Amount">
                            <br>
                            <input type="submit" class="btn" name="dipth" value="Deposit">
                        </form>
