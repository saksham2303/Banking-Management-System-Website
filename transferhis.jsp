       ...
       String pinno = (String)session.getAttribute("pinno");
        ...
        <div class="py pe">
            <div class="header">
                ...
                <div class="sim">
                    <div class="user-sim">
                        <h1>Intra-Bank Transfer History</h1>
                        <h2>Account no: <%
                            out.print(accno);
                        %></h2>
                        ...
                        <table>
                                    <tr>
                                        ...
                                        <td class="td">Receiver Account No</td>
                                        <td class="td">Amount</td>
                                        <td class="td">Receiver Account user id</td>
                                ...
                                ResultSet rh = sd.executeQuery("select * from transfer_table where Account_no ="+accno);
                                int c = 1;
                                while(rh.next())
{
                                %>
